...
// 	}
// } );
a(".wpb-carousel-gallery").each(function(){a(this).flickity({wrapAround:!0,groupCells:!0,prevNextButtons:!1,cellSelector:".wpb-block"}).on("dragStart.flickity",function(){a(".wpb-lightbox").addClass("wpb-disabled")}).on("dragEnd.flickity",function(){setTimeout(function(){a(".wpb-lightbox").removeClass("wpb-disabled")},1e3)})})},/**
		 * Video carousel
		 */
