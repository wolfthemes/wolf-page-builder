...
var f,g=(c("html").hasClass("touch"),!navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(Android)|(PlayBook)|(BB10)|(BlackBerry)|(Opera Mini)|(IEMobile)|(webOS)|(MeeGo)/i)),h=(!!navigator.userAgent.match(/(iPad)|(iPhone)|(iPod)|(Android)|(PlayBook)|(BB10)|(BlackBerry)|(Opera Mini)|(IEMobile)|(webOS)|(MeeGo)/i),{
...
c(a).resize(function(){e.setSliderHeight(b,d)}).resize()},/**
			 ...
			 */
setSliderHeight:function(b,d){var e,f=this,g=f.getToolBarOffset(),h=2;e=parseInt(b,10),"%"===d&&(e=Math.floor(c(a).height()*b/100)),c(".wpm-sticky-playlist-container").length&&(g+=c(".wpm-sticky-playlist-container").height()),e=e-g+h,c(i.settings.selector).find(".slide").each(function(){c(this).css({height:e})})},getToolBarOffset:function(){var b=0;return c("body").is(".admin-bar")&&(b=782<c(a).width()?32:46),b},/**
			 * Preload all slide videos if any
			 *
			 * @todo
			 */
loadAllVideos:function(){c(i.settings.selector).find(".wpb-slide-video").each(function(){c(this).parents(".wpb-slide").addClass("pause")})},/**
			 * Play video
			 */
playCurrentVideo:function(){if(c(i.settings.selector).find(".flex-active-slide .wpb-slide-video").length){var a=c(".flex-active-slide"),b=a.find(".wpb-slide-video");this.playToggleVideo(b)}},/**
			 * Play/Pause a video
			 */
...
!0===c?(a.prop("muted",!1),a.data("video-mute",!1),b.addClass("unmute")):(a.prop("muted",!0),a.data("video-mute",!0),b.removeClass("unmute"))},/**
			 * Pause all videos
			 */
pauseAllVideos:function(){var a;c(i.settings.selector).find(".wpb-slide-video").length&&c(i.settings.selector).find(".wpb-slide-video").each(function(){a=c(this),
// Pause all videos
a.get(0).pause(),a.data("video-play",!1),a.parent().parent().addClass("pause")})},/**
			 * Mute button
			 */
